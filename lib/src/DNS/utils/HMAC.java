 ...
 *             byte [] key)} instead.
 * @see        org.xbill.DNS.utils.HMAC#HMAC(java.security.MessageDigest digest, int blockLength, byte [] key)
 */
public
 ...
 *             instead
 * @see        org.xbill.DNS.utils.HMAC#HMAC(String digestName, int blockLength, byte [] key)
 */
public
