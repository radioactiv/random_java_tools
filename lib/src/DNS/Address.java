 ...
 * @exception java.net.UnknownHostException The hostname does not have any addresses
 */
 ...
 * @exception java.net.UnknownHostException The address is not a valid IP address.
 */
public static InetAddress
 ...
 * @return The IP addresses
 * @exception java.net.UnknownHostException The address is not a valid IP address in
 ...
 * @exception java.net.UnknownHostException There is no hostname for the address
 */
public static String
